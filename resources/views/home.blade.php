    ...
    <div class="row">
        @forelse($stories as $story)
            <div class="col-6 col-md-3 mb-4">
                <div class="card h-100 border-0 shadow-sm hover-card adaptive-card" style="transition: transform 0.2s; overflow: hidden;">
                    
                    <div class="position-relative" style="height: 300px; overflow: hidden;">
                        <a href="{{ route('story.show', $story->slug) }}">
                            @if($story->cover_image)
                                <img src="{{ asset('storage/' . $story->cover_image) }}" class="w-100 h-100" style="object-fit: cover;" alt="{{ $story->title }}">
                            @else
                    ...
                    <div class="card-body d-flex flex-column p-3">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center pt-2 border-top border-light-subtle">
                            <small class="text-muted d-flex align-items-center">
                                <i class="bi bi-pen me-1"></i> 
                                <span class="text-truncate" style="max-width: 80px;">
                                    {{ $story->author ? $story->author->name : 'Admin' }}
                                </span>
                            </small>
                            
                            <small class="text-muted d-flex align-items-center" title="{{ number_format($story->views) }} Pembaca">
