                        ...
                        @auth
                            @if(Auth::user()->is_banned)
                                <div class="alert alert-danger border-danger">
                                    ...
                                    <strong>Akun Ditangguhkan:</strong> Anda tidak dapat menulis ulasan saat ini.
                                </div>
                            @else
                                <div class="card mb-5 adaptive-card p-4">
                                    <h5 class="fw-bold">Tulis Ulasan Anda</h5>
                        ...
                        <form action="{{ route('story.review.store', $story->id) }}" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select name="rating" class="form-select border-secondary">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <textarea name="body" 
                                              class="form-control border-secondary @error('body') is-invalid @enderror" 
                                              rows="2" 
